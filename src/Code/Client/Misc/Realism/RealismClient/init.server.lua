...
function CharacterRealism:AddMotor(rotator, motor)
	...
	if parent and parent.Name == "Head" then
		parent.CanCollide = true -- FORK: We want the head to collide actually
	end
...
if script:IsA("ModuleScript") then
	...
	-- Sanity check
	--assert(script:FindFirstAncestorOfClass("PlayerScripts"), "RealismClient must be a descendant of the PlayerScripts!") -- FORK: I prefer using this outside PlayerScripts with RunContext
